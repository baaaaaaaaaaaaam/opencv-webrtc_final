...
public abstract class CameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    protected void deliverAndDrawFrame(CvCameraViewFrame frame) throws IOException {
        //Log.d("Test112","deliverAndDrawFrame");
        Mat modified;
        ...
        if (bmpValid && mCacheBitmap != null) {
            ...
            if (canvas != null) {
                ...
                Bitmap outputBitmap = Bitmap.createBitmap(mCacheBitmap, 0, 0, mCacheBitmap.getWidth(), mCacheBitmap.getHeight(), matrix, false);
                ...
                canvas.drawBitmap(outputBitmap, 0, -100, null);
